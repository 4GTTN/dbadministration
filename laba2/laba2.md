...
Во втором задании нужно было выполнить полное резервное копирование базы данных из лаб. №1 и использовать различные параметры, объяснить разницу. При выполнении полного резервного копирования бд были использвоаны параметры -Fc, -Ft, -s и -a .
...
В данном задании нужно было восстановить базу из резервного файла с помощью pg_restore или утилиты psql. Для востановления базы данных amm была создана новая бд amm_restore, куда будут восстанавливаться данные.

![Рисунок 3](photo/3.png)
